<script setup>
const navigateToMap = () => {
    window.open('https://maps.app.goo.gl/Y9WbkanGKJ1ias6o8', '_blank');
};
</script>

<template>
    <section id="contact" aria-label="Contact Murad United General Contracting & Trading Establishment Company">

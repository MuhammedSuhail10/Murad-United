<template>
    <section id="values" aria-label="Core values of Murad United General Contracting & Trading Establishment Company">
        ...
        <div class="lg:px-[12em] px-[1em] lg:py-[5em] py-[2em]">
            <div>
                <p class="font-[sansita] text-center lg:text-[3em] text-[2em] text-[#001f4e]">Differences We Make</p>
            </div>
            <div class="my-[2em] flex flex-col md:flex-row flex-wrap gap-[1.5em] justify-between">
                <div
                    ...
                    <h3 class="text-[16pt] text-[#001f4e] font-bold italic mb-[0.5em]">Transparency, Honesty, And
                        Integrity</h3>
                    <p class="text-[13pt]">We uphold the highest standards of transparency, honesty, and integrity in
                ...
                <div
                    ...
                    <h3 class="text-[16pt] text-[#001f4e] font-bold italic mb-[0.5em]">Environmental Protection And
                        Sustainable
                        Development</h3>
                    <p class="text-[13pt]">We actively promote environmental protection and sustainable practices,
                        contributing to a greener future and responsible business operations.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-[13pt]">Encouraging and promoting human rights, better health, and safety for our
                        team members, clients, and the community at large, prioritizing overall well-being.</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-[16pt] text-[#001f4e] font-bold italic mb-[0.5em]">Innovation And Continuous
                        Improvement</h3>
                    <p class="text-[13pt]">We embrace a culture of continuous innovation, adopting the latest
                        technologies, and fostering teamwork for sustained growth and improvement.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-[13pt]">Placing customers at our core, Falcom United Contracting is dedicated to
                        satisfying their diverse needs with exceptional services and adherence to quality and ethical
                        practices.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-[13pt]">Actively engaging with the community, Falcom United Contracting is committed
                        to being a responsible corporate citizen, positively contributing to local development.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-[13pt]">We are committed to delivering the highest quality in every project,
                        ensuring every detail meets rigorous standards and exceeds client expectations.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-[13pt]">We foster a collaborative environment where every team member contributes
                        their expertise, driving collective success and delivering outstanding results together.</p>
                </div>

<script setup>
const navigateToMap = () => {
    window.open('https://maps.app.goo.gl/8vvkbsz5zq4WNd5y9', '_blank');
};
</script>

<template>
    <section id="contact" aria-label="Contact Falcom United General Contracting Est. Company">
        <h2 class="sr-only">Contact Murad United General Contracting & Trading Establishment</h2>
        <div class="lg:px-[12em] px-[1em] lg:py-[5em] ">
            ...
            <!-- <div class="flex flex-col lg:flex-row gap-[2em] my-[2em]">
                <div class="bg-[#C7C4B7]/50 lg:w-[50%] p-[2.5em] flex flex-col gap-[0.5em] rounded-[1.5em] lg:rounded-[3em]">
                    <div class=" lg:gap-[1em] gap-[0.5em] items-center">
                        ...
                        <p class="lg:text-[2em] text-[1.5em] font-bold ">Ajil M</p>
                        <p class="lg:text-[1.25em] text-[1.25em] italic">Operation Manager</p>
                    </div>
                ...
                <div class="bg-[#C7C4B7]/50 lg:w-[50%] p-[2.5em] flex flex-col gap-[0.5em] rounded-[1.5em] lg:rounded-[3em]">
                    <div class=" lg:gap-[1em] gap-[0.5em] items-center">
                        ...
                        <p class="lg:text-[2em] text-[1.5em] font-bold ">Faris Mohammed Al- Zuraya</p>
                        <p class="lg:text-[1.25em] text-[1.25em] italic">CEO</p>
                    </div>
                    <div class="flex lg:gap-[1em] gap-[0.5em] items-center">
                        <div class="bg-[#960001] p-[0.5em] rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24"
                        ...
                        <a href="tel:+966 55 861 8001" class="lg:text-[1.5em] text-[1.25em] hover:text-[#960001]">+966
                            55 861 8001</a>
                    </div>
                    <div class="flex lg:gap-[1em] gap-[0.5em] items-center">
                        <div class="bg-[#960001] p-[0.5em] rounded-full">
                        ...
                        <a href="mailto:faris@falcomunited.com"
                            class="lg:text-[1.5em] text-[1.25em] hover:text-[#960001]">faris@falcomunited.com</a>
                    </div>
                </div>
            </div> -->
            <!-- <div class="flex flex-col gap-[2em] my-[2em]">
                <div class="flex lg:gap-[2em] gap-[1em] items-start">
                    <div class="bg-[#960001] p-[1em] rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px"
                            fill="#ffffff">
                            <path
                    ...
                    <div>
                        <p @click="navigateToMap"
                            class="lg:text-[1.5em] mb-[1em] text-[1.25em] cursor-pointer hover:text-[#960001]">
                            Falcom United General Contracting Establishment, Building
